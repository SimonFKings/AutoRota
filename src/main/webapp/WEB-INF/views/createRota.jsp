...
<form:form name="rota" modelAttribute="rota" action="/rota/add" method="POST">
    ...
    <table border="1">
        <tr>
            ...
            <form:label path="weekNum">You are creating a rota for Week </form:label>
...
For a summary and details on the weights for each factor into the predictions, click below: <br>
<textarea readonly=true rows="1" cols="10">${modelSummary}</textarea>
